...
const About = () => {
  return (
    <div className="md:w-[80%] m-auto px-4" id="about">
      ...
      <div className="flex flex-col-reverse md:flex-row justify-center items-center gap-2 md:gap-14 pb-10 md:pb-20">
        <div className="flex-1 md:flex-2">
          <img
            src={nataCover}
            alt=""
        ...
        <div className="flex-1 md:flex-2">
          <p className="text-sm text-justify md:text-md leading-[29px] pb-10 md:pb-0">
